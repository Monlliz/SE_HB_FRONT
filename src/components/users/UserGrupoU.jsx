...
import { getCambioGrupoFields, getAddMateriaFields } from "../../config/camposGrupo.jsx";
        ...
        {mode === "grupo" && (
          <>
            <Tooltip title="Lista general">
                <IconButton onClick={nav.irAListaGeneral}><ListAlt /></IconButton>
            </Tooltip>
            {isDirector && (
              <>
                <Tooltip title="Resumen TC">
                    <IconButton onClick={nav.irAResumenTC}><FileUser /></IconButton>
                </Tooltip>
                <Tooltip title="Cambiar Grupo">
                    <IconButton onClick={() => setActiveModal("CHANGE_GROUP")}><Group /></IconButton>
                </Tooltip>
              </>
            )}
          </>
        ...
        {isDirector && (
            <>
                <Tooltip title="Agregar">
                    <Button variant="text" startIcon={<Plus />} onClick={handleOpenAdd}>Agregar</Button>
                </Tooltip>
                ...
                <Tooltip title="Lista">
                    <IconButton 
                        disabled={!selectedMateria.clave} 
                        onClick={() => nav.irAListaMateria(selectedMateria.clave, selectedMateria.nombre)}
                    >
                        <ListAlt />
                    </IconButton>
                </Tooltip>
                ...
                <Tooltip title="Actividades">
                    <IconButton 
                        disabled={!selectedMateria.clave} 
                        onClick={() => nav.irAActividades(selectedMateria.clave, selectedMateria.nombre)}
                    >
                        <AutoStories />
                    </IconButton>
                </Tooltip>
                ...
                <Tooltip title="Rubros">
                    <IconButton 
                        disabled={!selectedMateria.clave} 
                        onClick={() => nav.irARubros(selectedMateria.clave, selectedMateria.nombre)}
                    >
                        <Checklist />
                    </IconButton>
                </Tooltip>
